...
#include <jni.h>
/* Header for class com_swyftwallet_core_BRCorePeerManager */

#ifndef _Included_com_swyftwallet_core_BRCorePeerManager
#define _Included_com_swyftwallet_core_BRCorePeerManager
#ifdef __cplusplus
extern "C" {
#endif
/*
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_swyftwallet_core_BRCorePeerManager_getConnectStatusValue
  (JNIEnv *, jobject);
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_swyftwallet_core_BRCorePeerManager_connect
  (JNIEnv *, jobject);
 ...
 */
JNIEXPORT jstring JNICALL Java_com_swyftwallet_core_BRCorePeerManager_getCurrentPeerName
  (JNIEnv *, jobject);
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_swyftwallet_core_BRCorePeerManager_disconnect
  (JNIEnv *, jobject);
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_swyftwallet_core_BRCorePeerManager_rescan
  (JNIEnv *, jobject);
 ...
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_com_swyftwallet_core_BRCorePeerManager_getEstimatedBlockHeight
  (JNIEnv *, jobject);
 ...
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_com_swyftwallet_core_BRCorePeerManager_getLastBlockHeight
  (JNIEnv *, jobject);
 ...
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_com_swyftwallet_core_BRCorePeerManager_getLastBlockTimestamp
  (JNIEnv *, jobject);
 ...
 * Signature: (J)D
 */
JNIEXPORT jdouble JNICALL Java_com_swyftwallet_core_BRCorePeerManager_getSyncProgress
  (JNIEnv *, jobject, jlong);
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_swyftwallet_core_BRCorePeerManager_getPeerCount
  (JNIEnv *, jobject);
 ...
 * Signature: ()Ljava/lang/String;
 */
JNIEXPORT jstring JNICALL Java_com_swyftwallet_core_BRCorePeerManager_getDownloadPeerName
  (JNIEnv *, jobject);
 ...
 * Signature: ([B)J
 */
JNIEXPORT jlong JNICALL Java_com_swyftwallet_core_BRCorePeerManager_getRelayCount
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_swyftwallet_core_BRCorePeerManager_disposeNative
  (JNIEnv *, jobject);
