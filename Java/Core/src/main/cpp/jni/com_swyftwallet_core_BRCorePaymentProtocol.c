...
#include "com_swyftwallet_core_BRCorePaymentProtocol.h"
...
Java_com_swyftwallet_core_BRCorePaymentProtocolRequest_getNetwork
...
Java_com_swyftwallet_core_BRCorePaymentProtocolRequest_getTime
        (JNIEnv *env, jobject thisObject) {
    BRPaymentProtocolRequest *request =
            (BRPaymentProtocolRequest *) getJNIReference(env, thisObject);
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_swyftwallet_core_BRCorePaymentProtocolRequest_getExpires
        (JNIEnv *env, jobject thisObject) {
    BRPaymentProtocolRequest *request =
            (BRPaymentProtocolRequest *) getJNIReference(env, thisObject);
 ...
 */
JNIEXPORT jstring JNICALL
Java_com_swyftwallet_core_BRCorePaymentProtocolRequest_getMemo
        (JNIEnv *env, jobject thisObject) {
    BRPaymentProtocolRequest *request =
            (BRPaymentProtocolRequest *) getJNIReference(env, thisObject);
 ...
 */
JNIEXPORT jstring JNICALL
Java_com_swyftwallet_core_BRCorePaymentProtocolRequest_getPaymentURL
        (JNIEnv *env, jobject thisObject) {
    BRPaymentProtocolRequest *request =
            (BRPaymentProtocolRequest *) getJNIReference(env, thisObject);
...
Java_com_swyftwallet_core_BRCorePaymentProtocolRequest_getMerchantData
        (JNIEnv *env, jobject thisObject) {
    BRPaymentProtocolRequest *request =
            (BRPaymentProtocolRequest *) getJNIReference(env, thisObject);
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_swyftwallet_core_BRCorePaymentProtocolRequest_getVersion
        (JNIEnv *env, jobject thisObject) {
    BRPaymentProtocolRequest *request =
            (BRPaymentProtocolRequest *) getJNIReference(env, thisObject);
 ...
 */
JNIEXPORT jstring JNICALL
Java_com_swyftwallet_core_BRCorePaymentProtocolRequest_getPKIType
        (JNIEnv *env, jobject thisObject) {
    BRPaymentProtocolRequest *request =
            (BRPaymentProtocolRequest *) getJNIReference(env, thisObject);
 ...
 */
JNIEXPORT jbyteArray JNICALL
Java_com_swyftwallet_core_BRCorePaymentProtocolRequest_getPKIData
        (JNIEnv *env, jobject thisObject) {
    BRPaymentProtocolRequest *request =
            (BRPaymentProtocolRequest *) getJNIReference(env, thisObject);
 ...
 */
JNIEXPORT jbyteArray JNICALL
Java_com_swyftwallet_core_BRCorePaymentProtocolRequest_getSignature
        (JNIEnv *env, jobject thisObject) {
    BRPaymentProtocolRequest *request =
            (BRPaymentProtocolRequest *) getJNIReference(env, thisObject);
 ...
 * Signature: ()[B
 */
JNIEXPORT jbyteArray JNICALL Java_com_swyftwallet_core_BRCorePaymentProtocolRequest_getDigest
        (JNIEnv *env, jobject thisObject) {
    BRPaymentProtocolRequest *request =
            (BRPaymentProtocolRequest *) getJNIReference(env, thisObject);
 ...
 * Signature: ()[[B
 */
JNIEXPORT jobjectArray JNICALL Java_com_swyftwallet_core_BRCorePaymentProtocolRequest_getCerts
        (JNIEnv *env, jobject thisObject){
    BRPaymentProtocolRequest *request =
            (BRPaymentProtocolRequest *) getJNIReference(env, thisObject);
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_swyftwallet_core_BRCorePaymentProtocolRequest_createPaymentProtocolRequest
 ...
 */
JNIEXPORT jbyteArray JNICALL
Java_com_swyftwallet_core_BRCorePaymentProtocolRequest_serialize
        (JNIEnv *env, jobject thisObject) {
...
Java_com_swyftwallet_core_BRCorePaymentProtocolRequest_disposeNative
        (JNIEnv *env, jobject thisObject) {
    BRPaymentProtocolRequest *request = (BRPaymentProtocolRequest *) getJNIReference (env, thisObject);
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_swyftwallet_core_BRCorePaymentProtocolRequest_initializeNative
 ...
 */
JNIEXPORT jbyteArray JNICALL
Java_com_swyftwallet_core_BRCorePaymentProtocolPayment_getMerchantData
        (JNIEnv *env, jobject thisObject) {
 ...
 */
JNIEXPORT jstring JNICALL
Java_com_swyftwallet_core_BRCorePaymentProtocolPayment_getMerchantMemo
        (JNIEnv *env, jobject thisObject) {
    BRPaymentProtocolPayment *payment =
            (BRPaymentProtocolPayment *) getJNIReference (env, thisObject);
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_swyftwallet_core_BRCorePaymentProtocolPayment_createPaymentProtocolPayment
        (JNIEnv *env, jclass thisClass, jbyteArray dataByteArray)  {
    size_t dataLen = (*env)->GetArrayLength(env, dataByteArray);
    const uint8_t *data = (uint8_t *) (*env)->GetByteArrayElements(env, dataByteArray, 0);
 ...
 */
JNIEXPORT void JNICALL
Java_com_swyftwallet_core_BRCorePaymentProtocolPayment_disposeNative
        (JNIEnv *env, jobject thisObject) {
    BRPaymentProtocolPayment *payment =
            (BRPaymentProtocolPayment *) getJNIReference (env, thisObject);
 ...
 */
JNIEXPORT jstring JNICALL
Java_com_swyftwallet_core_BRCorePaymentProtocolACK_getCustomerMemo
        (JNIEnv *env, jobject thisObject)  {
 ...
 */
JNIEXPORT jbyteArray JNICALL
Java_com_swyftwallet_core_BRCorePaymentProtocolACK_getMerchantData
        (JNIEnv *env, jobject thisObject)  {
    BRPaymentProtocolACK *ack = (BRPaymentProtocolACK *) getJNIReference (env, thisObject);
 ...
 */
JNIEXPORT jstring JNICALL
Java_com_swyftwallet_core_BRCorePaymentProtocolACK_getMerchantMemo
        (JNIEnv *env, jobject thisObject) {
    BRPaymentProtocolACK *ack = (BRPaymentProtocolACK *) getJNIReference (env, thisObject);
    BRPaymentProtocolPayment *payment = ack->payment;
 ...
 * Signature: ([B)J
 */
JNIEXPORT jlong JNICALL Java_com_swyftwallet_core_BRCorePaymentProtocolACK_createPaymentProtocolACK
        (JNIEnv *env, jclass thisClass, jbyteArray dataByteArray) {
    size_t dataLen = (*env)->GetArrayLength(env, dataByteArray);
    const uint8_t *data = (uint8_t *) (*env)->GetByteArrayElements(env, dataByteArray, 0);
 ...
 */
JNIEXPORT jbyteArray JNICALL
Java_com_swyftwallet_core_BRCorePaymentProtocolACK_serialize
        (JNIEnv *env, jobject thisObject) {
    BRPaymentProtocolACK *ack = (BRPaymentProtocolACK *) getJNIReference (env, thisObject);
 ...
 */
JNIEXPORT void JNICALL
Java_com_swyftwallet_core_BRCorePaymentProtocolACK_disposeNative
        (JNIEnv *env, jobject thisObject) {
    BRPaymentProtocolACK *ack = (BRPaymentProtocolACK *) getJNIReference (env, thisObject);
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_swyftwallet_core_BRCorePaymentProtocolACK_initializeNative
        (JNIEnv *env, jclass thisClass) {
    commonStaticInitialize(env);
}
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_swyftwallet_core_BRCorePaymentProtocolInvoiceRequest_getSenderPublicKeyReference
        (JNIEnv *env, jobject thisObject) {
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_swyftwallet_core_BRCorePaymentProtocolInvoiceRequest_getAmount
        (JNIEnv *env, jobject thisObject) {
    BRPaymentProtocolInvoiceRequest *request =
            (BRPaymentProtocolInvoiceRequest *) getJNIReference (env, thisObject);
 ...
 */
JNIEXPORT jstring JNICALL
Java_com_swyftwallet_core_BRCorePaymentProtocolInvoiceRequest_getPKIType
        (JNIEnv *env, jobject thisObject) {
    BRPaymentProtocolInvoiceRequest *request =
            (BRPaymentProtocolInvoiceRequest *) getJNIReference (env, thisObject);
    return (*env)->NewStringUTF (env, request->pkiType);
 ...
 */
JNIEXPORT jbyteArray JNICALL
Java_com_swyftwallet_core_BRCorePaymentProtocolInvoiceRequest_getPKIData
        (JNIEnv *env, jobject thisObject) {
    BRPaymentProtocolInvoiceRequest *request =
            (BRPaymentProtocolInvoiceRequest *) getJNIReference (env, thisObject);
 ...
 */
JNIEXPORT jstring JNICALL
Java_com_swyftwallet_core_BRCorePaymentProtocolInvoiceRequest_getMemo
        (JNIEnv *env, jobject thisObject) {
    BRPaymentProtocolInvoiceRequest *request =
            (BRPaymentProtocolInvoiceRequest *) getJNIReference (env, thisObject);
 ...
 */
JNIEXPORT jstring JNICALL
Java_com_swyftwallet_core_BRCorePaymentProtocolInvoiceRequest_getNotifyURL
        (JNIEnv *env, jobject thisObject) {
    BRPaymentProtocolInvoiceRequest *request =
            (BRPaymentProtocolInvoiceRequest *) getJNIReference (env, thisObject);
 ...
 */
JNIEXPORT jbyteArray JNICALL
Java_com_swyftwallet_core_BRCorePaymentProtocolInvoiceRequest_getSignature
        (JNIEnv *env, jobject thisObject) {
    BRPaymentProtocolInvoiceRequest *request =
            (BRPaymentProtocolInvoiceRequest *) getJNIReference (env, thisObject);
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_swyftwallet_core_BRCorePaymentProtocolInvoiceRequest_createPaymentProtocolInvoiceRequest
        (JNIEnv *env, jclass thisClass, jbyteArray dataByteArray) {
    size_t dataLen = (*env)->GetArrayLength(env, dataByteArray);
    const uint8_t *data = (uint8_t *) (*env)->GetByteArrayElements(env, dataByteArray, 0);
 ...
 * Signature: ()[B
 */
JNIEXPORT jbyteArray JNICALL Java_com_swyftwallet_core_BRCorePaymentProtocolInvoiceRequest_serialize
        (JNIEnv *env, jobject thisObject) {
    BRPaymentProtocolInvoiceRequest *request =
            (BRPaymentProtocolInvoiceRequest *) getJNIReference(env, thisObject);
 ...
 */
JNIEXPORT void JNICALL
Java_com_swyftwallet_core_BRCorePaymentProtocolInvoiceRequest_disposeNative
        (JNIEnv *env, jobject thisObject) {
    BRPaymentProtocolInvoiceRequest *request =
            (BRPaymentProtocolInvoiceRequest *) getJNIReference (env, thisObject);
...
/*
 * Class:     com_swyftwallet_core_BRCorePaymentProtocolMessage
 * Method:    getMessageTypeValue
 * Signature: ()I
 */
JNIEXPORT jint JNICALL
Java_com_swyftwallet_core_BRCorePaymentProtocolMessage_getMessageTypeValue
        (JNIEnv *env, jobject thisObject) {
 ...
 */
JNIEXPORT jbyteArray JNICALL
Java_com_swyftwallet_core_BRCorePaymentProtocolMessage_getMessage
        (JNIEnv *env, jobject thisObject) {
    BRPaymentProtocolMessage *message =
            (BRPaymentProtocolMessage *) getJNIReference(env, thisObject);
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_swyftwallet_core_BRCorePaymentProtocolMessage_getStatusCode
        (JNIEnv *env, jobject thisObject) {
    BRPaymentProtocolMessage *message =
            (BRPaymentProtocolMessage *) getJNIReference (env, thisObject);
 ...
 */
JNIEXPORT jstring JNICALL
Java_com_swyftwallet_core_BRCorePaymentProtocolMessage_getStatusMessage
        (JNIEnv *env, jobject thisObject) {
    BRPaymentProtocolMessage *message =
            (BRPaymentProtocolMessage *) getJNIReference (env, thisObject);
 ...
 */
JNIEXPORT jbyteArray JNICALL
Java_com_swyftwallet_core_BRCorePaymentProtocolMessage_getIdentifier
        (JNIEnv *env, jobject thisObject) {
    BRPaymentProtocolMessage *message =
            (BRPaymentProtocolMessage *) getJNIReference (env, thisObject);
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_swyftwallet_core_BRCorePaymentProtocolMessage_createPaymentProtocolMessage
        (JNIEnv *env, jclass thisClass, jbyteArray dataByteArray) {
    size_t dataLen = (*env)->GetArrayLength(env, dataByteArray);
    const uint8_t *data = (uint8_t *) (*env)->GetByteArrayElements(env, dataByteArray, 0);
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_swyftwallet_core_BRCorePaymentProtocolMessage_createPaymentProtocolMessageFull
        (JNIEnv *env, jclass thisClass,
         jint messageType,
 ...
 * Signature: ()[B
 */
JNIEXPORT jbyteArray JNICALL Java_com_swyftwallet_core_BRCorePaymentProtocolMessage_serialize
        (JNIEnv *env, jobject thisObject) {
    BRPaymentProtocolMessage *message =
            (BRPaymentProtocolMessage *) getJNIReference(env, thisObject);
 ...
 */
JNIEXPORT void JNICALL
Java_com_swyftwallet_core_BRCorePaymentProtocolMessage_disposeNative
        (JNIEnv *env, jobject thisObject) {
    BRPaymentProtocolMessage *message =
            (BRPaymentProtocolMessage *) getJNIReference (env, thisObject);
...
//
/*
 * Class:     com_swyftwallet_core_BRCorePaymentProtocolEncryptedMessage
 * Method:    getMessage
 * Signature: ()[B
 */
JNIEXPORT jbyteArray JNICALL
Java_com_swyftwallet_core_BRCorePaymentProtocolEncryptedMessage_getMessage
        (JNIEnv *env, jobject thisObject) {
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_swyftwallet_core_BRCorePaymentProtocolEncryptedMessage_getReceiverPublicKeyReference
        (JNIEnv *env, jobject thisObject) {
    BRPaymentProtocolEncryptedMessage *message =
            (BRPaymentProtocolEncryptedMessage *) getJNIReference(env, thisObject);
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_swyftwallet_core_BRCorePaymentProtocolEncryptedMessage_getSenderPublicKeyReference
        (JNIEnv *env, jobject thisObject) {
    BRPaymentProtocolEncryptedMessage *message =
            (BRPaymentProtocolEncryptedMessage *) getJNIReference(env, thisObject);
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_swyftwallet_core_BRCorePaymentProtocolEncryptedMessage_getNonce
        (JNIEnv *env, jobject thisObject) {
    BRPaymentProtocolEncryptedMessage *message =
            (BRPaymentProtocolEncryptedMessage *) getJNIReference(env, thisObject);
 ...
 */
JNIEXPORT jbyteArray JNICALL
Java_com_swyftwallet_core_BRCorePaymentProtocolEncryptedMessage_getSignature
        (JNIEnv *env, jobject thisObject) {
    BRPaymentProtocolEncryptedMessage *message =
            (BRPaymentProtocolEncryptedMessage *) getJNIReference(env, thisObject);
 ...
 */
JNIEXPORT jbyteArray JNICALL
Java_com_swyftwallet_core_BRCorePaymentProtocolEncryptedMessage_getIdentifier
        (JNIEnv *env, jobject thisObject) {
    BRPaymentProtocolEncryptedMessage *message =
            (BRPaymentProtocolEncryptedMessage *) getJNIReference(env, thisObject);
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_swyftwallet_core_BRCorePaymentProtocolEncryptedMessage_getStatusCode
        (JNIEnv *env, jobject thisObject) {
    BRPaymentProtocolEncryptedMessage *message =
            (BRPaymentProtocolEncryptedMessage *) getJNIReference(env, thisObject);
 ...
 */
JNIEXPORT jstring JNICALL
Java_com_swyftwallet_core_BRCorePaymentProtocolEncryptedMessage_getStatusMessage
        (JNIEnv *env, jobject thisObject) {
    BRPaymentProtocolEncryptedMessage *message =
            (BRPaymentProtocolEncryptedMessage *) getJNIReference(env, thisObject);
    return (*env)->NewStringUTF (env, message->statusMsg);
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_swyftwallet_core_BRCorePaymentProtocolEncryptedMessage_createPaymentProtocolEncryptedMessage
        (JNIEnv *env, jclass thisClass, jbyteArray dataByteArray) {
    size_t dataLen = (*env)->GetArrayLength(env, dataByteArray);
    const uint8_t *data = (uint8_t *) (*env)->GetByteArrayElements(env, dataByteArray, 0);
 ...
 * Signature: ()[B
 */
JNIEXPORT jbyteArray JNICALL Java_com_swyftwallet_core_BRCorePaymentProtocolEncryptedMessage_serialize
        (JNIEnv *env, jobject thisObject) {
    BRPaymentProtocolEncryptedMessage *message =
            (BRPaymentProtocolEncryptedMessage *) getJNIReference(env, thisObject);
 ...
 */
JNIEXPORT void JNICALL
Java_com_swyftwallet_core_BRCorePaymentProtocolEncryptedMessage_disposeNative
        (JNIEnv *env, jobject thisObject) {
    BRPaymentProtocolEncryptedMessage *message =
            (BRPaymentProtocolEncryptedMessage *) getJNIReference(env, thisObject);
