//
//  com_swyftwallet_core_ethereum_BREthereumToken
...
#include "com_swyftwallet_core_ethereum_BREthereumToken.h"
...
/*
 * Class:     com_swyftwallet_core_ethereum_BREthereumToken
 * Method:    getAddress
 * Signature: ()Ljava/lang/String;
 */
JNIEXPORT jstring JNICALL
Java_com_swyftwallet_core_ethereum_BREthereumToken_getAddress
 ...
 */
JNIEXPORT jstring JNICALL
Java_com_swyftwallet_core_ethereum_BREthereumToken_getSymbol
        (JNIEnv *env, jobject thisObject) {
    BREthereumToken token = (BREthereumToken) getJNIReference(env, thisObject);
 ...
 */
JNIEXPORT jstring JNICALL
Java_com_swyftwallet_core_ethereum_BREthereumToken_getName
        (JNIEnv *env, jobject thisObject)  {
    BREthereumToken token = (BREthereumToken) getJNIReference(env, thisObject);
 ...
 */
JNIEXPORT jstring JNICALL
Java_com_swyftwallet_core_ethereum_BREthereumToken_getDescription
        (JNIEnv *env, jobject thisObject) {
    BREthereumToken token = (BREthereumToken) getJNIReference(env, thisObject);
...
Java_com_swyftwallet_core_ethereum_BREthereumToken_getDecimals
        (JNIEnv *env, jobject thisObject) {
    BREthereumToken token = (BREthereumToken) getJNIReference(env, thisObject);
...
Java_com_swyftwallet_core_ethereum_BREthereumToken_jniGetTokenBRD
...
Java_com_swyftwallet_core_ethereum_BREthereumToken_jniTokenAll
        (JNIEnv *env, jclass thisClass) {
