...
#include "com_swyftwallet_core_BRCoreTransactionInput.h"

/*
 * Class:     com_swyftwallet_core_BRCoreTransactionInput
 * Method:    createTransactionInput
 * Signature: ([BJJ[B[B[BJ)J
 */
JNIEXPORT jlong JNICALL Java_com_swyftwallet_core_BRCoreTransactionInput_createTransactionInput
 ...
 */
JNIEXPORT jstring JNICALL Java_com_swyftwallet_core_BRCoreTransactionInput_getAddress
 ...
 */
JNIEXPORT void JNICALL Java_com_swyftwallet_core_BRCoreTransactionInput_setAddress
 ...
 * Signature: ()[B
 */
JNIEXPORT jbyteArray JNICALL Java_com_swyftwallet_core_BRCoreTransactionInput_getHash
        (JNIEnv *env, jobject thisObject) {
    BRTxInput *input = (BRTxInput *) getJNIReference (env, thisObject);
 ...
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_com_swyftwallet_core_BRCoreTransactionInput_getIndex
        (JNIEnv *env, jobject thisObject) {
    BRTxInput *input = (BRTxInput *) getJNIReference (env, thisObject);
 ...
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_com_swyftwallet_core_BRCoreTransactionInput_getAmount
        (JNIEnv *env, jobject thisObject) {
    BRTxInput *input = (BRTxInput *) getJNIReference (env, thisObject);
 ...
 * Signature: ()[B
 */
JNIEXPORT jbyteArray JNICALL Java_com_swyftwallet_core_BRCoreTransactionInput_getScript
        (JNIEnv *env, jobject thisObject) {
    BRTxInput *input = (BRTxInput *) getJNIReference (env, thisObject);
 ...
 * Signature: ()[B
 */
JNIEXPORT jbyteArray JNICALL Java_com_swyftwallet_core_BRCoreTransactionInput_getSignature
        (JNIEnv *env, jobject thisObject) {
    BRTxInput *input = (BRTxInput *) getJNIReference (env, thisObject);
 ...
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_com_swyftwallet_core_BRCoreTransactionInput_getSequence
        (JNIEnv *env, jobject thisObject) {
    BRTxInput *input = (BRTxInput *) getJNIReference (env, thisObject);
