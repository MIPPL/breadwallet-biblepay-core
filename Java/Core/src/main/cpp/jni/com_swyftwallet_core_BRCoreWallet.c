...
#include "com_swyftwallet_core_BRCoreWallet.h"
#include "com_swyftwallet_core_BRCoreTransaction.h"

static BRTransaction *
JNI_COPY_TRANSACTION (BRTransaction *tx) {
    if (com_swyftwallet_core_BRCoreTransaction_JNI_COPIES_TRANSACTIONS && NULL != tx) {
...
Java_com_swyftwallet_core_BRCoreWallet_createJniCoreWallet
...
Java_com_swyftwallet_core_BRCoreWallet_getReceiveAddress
...
Java_com_swyftwallet_core_BRCoreWallet_getAllAddresses
        (JNIEnv *env, jobject thisObject) {
    BRWallet *wallet = (BRWallet *) getJNIReference (env, thisObject);
...
Java_com_swyftwallet_core_BRCoreWallet_containsAddress
 ...
 */
JNIEXPORT jboolean JNICALL
Java_com_swyftwallet_core_BRCoreWallet_addressIsUsed
        (JNIEnv *env, jobject thisObject, jobject objAddress) {
    BRWallet  *wallet  = (BRWallet  *) getJNIReference (env, thisObject);
    BRAddress *address = (BRAddress *) getJNIReference (env, objAddress);
 ...
 */
JNIEXPORT jobjectArray JNICALL
Java_com_swyftwallet_core_BRCoreWallet_jniGetTransactions
        (JNIEnv *env, jobject thisObject) {
    BRWallet  *wallet  = (BRWallet  *) getJNIReference (env, thisObject);
 ...
 */
JNIEXPORT jobjectArray JNICALL
Java_com_swyftwallet_core_BRCoreWallet_getTransactionsConfirmedBefore
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_swyftwallet_core_BRCoreWallet_getBalance
        (JNIEnv *env, jobject thisObject) {
    BRWallet  *wallet  = (BRWallet  *) getJNIReference (env, thisObject);
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_swyftwallet_core_BRCoreWallet_getTotalSent
        (JNIEnv *env, jobject thisObject) {
    BRWallet  *wallet  = (BRWallet  *) getJNIReference (env, thisObject);
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_swyftwallet_core_BRCoreWallet_getTotalReceived
        (JNIEnv *env, jobject thisObject) {
    BRWallet  *wallet  = (BRWallet  *) getJNIReference (env, thisObject);
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_swyftwallet_core_BRCoreWallet_getFeePerKb
        (JNIEnv *env, jobject thisObject) {
    BRWallet  *wallet  = (BRWallet  *) getJNIReference (env, thisObject);
...
Java_com_swyftwallet_core_BRCoreWallet_setFeePerKb
 ...
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_com_swyftwallet_core_BRCoreWallet_getMaxFeePerKb
        (JNIEnv *env, jobject thisObject) {
 ...
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_com_swyftwallet_core_BRCoreWallet_getDefaultFeePerKb
        (JNIEnv *env, jobject thisObject) {
 ...
 */
JNIEXPORT jobject JNICALL
Java_com_swyftwallet_core_BRCoreWallet_createTransaction
 ...
 */
JNIEXPORT jboolean JNICALL
Java_com_swyftwallet_core_BRCoreWallet_signTransaction
        (JNIEnv *env, jobject thisObject,
         jobject transactionObject,
 ...
 */
JNIEXPORT jboolean JNICALL
Java_com_swyftwallet_core_BRCoreWallet_containsTransaction
 ...
 */
JNIEXPORT jboolean JNICALL
Java_com_swyftwallet_core_BRCoreWallet_jniRegisterTransaction
        (JNIEnv *env, jobject thisObject, jobject transactionObject) {
    BRWallet  *wallet  = (BRWallet  *) getJNIReference (env, thisObject);
    BRTransaction *transaction = (BRTransaction *) getJNIReference (env, transactionObject);
 ...
 */
JNIEXPORT void JNICALL
Java_com_swyftwallet_core_BRCoreWallet_removeTransaction
 ...
 */
JNIEXPORT void JNICALL
Java_com_swyftwallet_core_BRCoreWallet_updateTransactions
        (JNIEnv *env, jobject thisObject,
 ...
 */
JNIEXPORT jobject JNICALL
Java_com_swyftwallet_core_BRCoreWallet_jniTransactionForHash
        (JNIEnv *env, jobject thisObject, jbyteArray hashByteArray) {
    BRWallet  *wallet  = (BRWallet  *) getJNIReference (env, thisObject);
 ...
 * Signature: (Lcom_swyftwallet_/core/BRCoreTransaction;)I
 */
JNIEXPORT jboolean JNICALL
Java_com_swyftwallet_core_BRCoreWallet_transactionIsValid
        (JNIEnv *env, jobject thisObject, jobject transactionObject) {
    BRWallet  *wallet  = (BRWallet  *) getJNIReference (env, thisObject);
    BRTransaction *transaction = (BRTransaction *) getJNIReference (env, transactionObject);
 ...
 */
JNIEXPORT jboolean JNICALL
Java_com_swyftwallet_core_BRCoreWallet_transactionIsPending
        (JNIEnv *env, jobject thisObject, jobject transactionObject) {
    BRWallet  *wallet  = (BRWallet  *) getJNIReference (env, thisObject);
    BRTransaction *transaction = (BRTransaction *) getJNIReference (env, transactionObject);
 ...
 */
JNIEXPORT jboolean JNICALL
Java_com_swyftwallet_core_BRCoreWallet_transactionIsVerified
        (JNIEnv *env, jobject thisObject, jobject transactionObject) {
    BRWallet  *wallet  = (BRWallet  *) getJNIReference (env, thisObject);
    BRTransaction *transaction = (BRTransaction *) getJNIReference (env, transactionObject);
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_swyftwallet_core_BRCoreWallet_getTransactionFee
        (JNIEnv *env, jobject thisObject, jobject transactionObject) {
    BRWallet *wallet = (BRWallet *) getJNIReference (env, thisObject);
    BRTransaction *transaction = (BRTransaction *) getJNIReference (env, transactionObject);
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_swyftwallet_core_BRCoreWallet_getTransactionAmountSent
        (JNIEnv *env, jobject thisObject, jobject transactionObject) {
    BRWallet *wallet = (BRWallet *) getJNIReference (env, thisObject);
    BRTransaction *transaction = (BRTransaction *) getJNIReference (env, transactionObject);
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_swyftwallet_core_BRCoreWallet_getTransactionAmountReceived
        (JNIEnv *env, jobject thisObject, jobject transactionObject) {
    BRWallet *wallet = (BRWallet *) getJNIReference (env, thisObject);
    BRTransaction *transaction = (BRTransaction *) getJNIReference (env, transactionObject);
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_swyftwallet_core_BRCoreWallet_getBalanceAfterTransaction
        (JNIEnv *env, jobject thisObject, jobject transactionObject) {
    BRWallet *wallet = (BRWallet *) getJNIReference (env, thisObject);
    BRTransaction *transaction = (BRTransaction *) getJNIReference (env, transactionObject);
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_swyftwallet_core_BRCoreWallet_getFeeForTransactionSize
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_swyftwallet_core_BRCoreWallet_getFeeForTransactionAmount
 ...
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_com_swyftwallet_core_BRCoreWallet_getMinOutputAmount
        (JNIEnv *env, jobject thisObject) {
    BRWallet *wallet = (BRWallet *) getJNIReference (env, thisObject);
 ...
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_com_swyftwallet_core_BRCoreWallet_getMaxOutputAmount
        (JNIEnv *env, jobject thisObject) {
    BRWallet *wallet = (BRWallet *) getJNIReference (env, thisObject);
 ...
 */
JNIEXPORT void JNICALL
Java_com_swyftwallet_core_BRCoreWallet_disposeNative
        (JNIEnv *env, jobject thisObject) {
    BRWallet *wallet = (BRWallet *) getJNIReference(env, thisObject);
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_swyftwallet_core_BRCoreWallet_initializeNative
        (JNIEnv *env, jclass thisClass) {
    addressClass = (*env)->FindClass(env, "com_swyftwallet_/core/BRCoreAddress");
...
txAdded(void *info, BRTransaction *tx) {
    ...
    jmethodID listenerMethod =
            lookupListenerMethod(env, listener,
                                 "onTxAdded",
                                 "(Lcom_swyftwallet_/core/BRCoreTransaction;)V");
    assert (NULL != listenerMethod);
