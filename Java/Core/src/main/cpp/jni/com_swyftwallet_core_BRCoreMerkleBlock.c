...
#include "com_swyftwallet_core_BRCoreMerkleBlock.h"

/*
 * Class:     com_swyftwallet_core_BRCoreMerkleBlock
 * Method:    createJniCoreMerkleBlock
 * Signature: ([BI)J
 */
JNIEXPORT jlong JNICALL
Java_com_swyftwallet_core_BRCoreMerkleBlock_createJniCoreMerkleBlock
 ...
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_com_swyftwallet_core_BRCoreMerkleBlock_createJniCoreMerkleBlockEmpty
        (JNIEnv *env, jclass thisClass) {
    // Test only
...
Java_com_swyftwallet_core_BRCoreMerkleBlock_getBlockHash
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_swyftwallet_core_BRCoreMerkleBlock_getVersion
        (JNIEnv *env, jobject thisObject)  {
    BRMerkleBlock *block = (BRMerkleBlock *) getJNIReference(env, thisObject);
 ...
 */
JNIEXPORT jbyteArray JNICALL
Java_com_swyftwallet_core_BRCoreMerkleBlock_getPrevBlockHash
        (JNIEnv *env, jobject thisObject) {
    BRMerkleBlock *block = (BRMerkleBlock *) getJNIReference(env, thisObject);
 ...
 */
JNIEXPORT jbyteArray JNICALL
Java_com_swyftwallet_core_BRCoreMerkleBlock_getRootBlockHash
        (JNIEnv *env, jobject thisObject) {
    BRMerkleBlock *block = (BRMerkleBlock *) getJNIReference(env, thisObject);
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_swyftwallet_core_BRCoreMerkleBlock_getTimestamp
        (JNIEnv *env, jobject thisObject) {
    BRMerkleBlock *block = (BRMerkleBlock *) getJNIReference(env, thisObject);
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_swyftwallet_core_BRCoreMerkleBlock_getTarget
        (JNIEnv *env, jobject thisObject) {
    BRMerkleBlock *block = (BRMerkleBlock *) getJNIReference(env, thisObject);
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_swyftwallet_core_BRCoreMerkleBlock_getNonce
        (JNIEnv *env, jobject thisObject) {
    BRMerkleBlock *block = (BRMerkleBlock *) getJNIReference(env, thisObject);
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_swyftwallet_core_BRCoreMerkleBlock_getTransactionCount
        (JNIEnv *env, jobject thisObject) {
    BRMerkleBlock *block = (BRMerkleBlock *) getJNIReference(env, thisObject);
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_swyftwallet_core_BRCoreMerkleBlock_getHeight
        (JNIEnv *env, jobject thisObject) {
    BRMerkleBlock *block = (BRMerkleBlock *) getJNIReference(env, thisObject);
 ...
 * Signature: ()[B
 */
JNIEXPORT jbyteArray JNICALL Java_com_swyftwallet_core_BRCoreMerkleBlock_serialize
        (JNIEnv *env, jobject thisObject) {
    BRMerkleBlock *block = (BRMerkleBlock *) getJNIReference(env, thisObject);
...
Java_com_swyftwallet_core_BRCoreMerkleBlock_isValid
 ...
 */
JNIEXPORT jboolean JNICALL
Java_com_swyftwallet_core_BRCoreMerkleBlock_containsTransactionHash
...
Java_com_swyftwallet_core_BRCoreMerkleBlock_disposeNative
        (JNIEnv *env, jobject thisObject) {
    BRMerkleBlock *block = (BRMerkleBlock *) getJNIReference(env, thisObject);
