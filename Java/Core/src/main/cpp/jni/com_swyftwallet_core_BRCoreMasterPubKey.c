...
#include "com_swyftwallet_core_BRCoreMasterPubKey.h"

/*
 * Class:     com_swyftwallet_core_BRCoreMasterPubKey
 * Method:    serialize
 * Signature: ()[B
 */
JNIEXPORT jbyteArray JNICALL Java_com_swyftwallet_core_BRCoreMasterPubKey_serialize
 ...
 * Signature: ()[B
 */
JNIEXPORT jbyteArray JNICALL Java_com_swyftwallet_core_BRCoreMasterPubKey_getPubKey
        (JNIEnv *env, jobject thisObject) {
    BRMasterPubKey *key = (BRMasterPubKey *) getJNIReference (env, thisObject);
...
Java_com_swyftwallet_core_BRCoreMasterPubKey_createPubKey
        (JNIEnv *env, jobject thisObject) {
...
JNIEXPORT jlong JNICALL
Java_com_swyftwallet_core_BRCoreMasterPubKey_createJniCoreMasterPubKeyFromPhrase
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_swyftwallet_core_BRCoreMasterPubKey_createJniCoreMasterPubKeyFromSerialization
        (JNIEnv *env, jclass thisClass,
...
Java_com_swyftwallet_core_BRCoreMasterPubKey_bip32BitIDKey
...
Java_com_swyftwallet_core_BRCoreMasterPubKey_validateRecoveryPhrase
 ...
 */
JNIEXPORT jbyteArray JNICALL
Java_com_swyftwallet_core_BRCoreMasterPubKey_generatePaperKey
