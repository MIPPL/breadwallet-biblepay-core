...
#include "com_swyftwallet_core_BRCorePeerManager.h"
 ...
 */
JNIEXPORT jint
JNICALL Java_com_swyftwallet_core_BRCorePeerManager_getConnectStatusValue
...
Java_com_swyftwallet_core_BRCorePeerManager_connect
        (JNIEnv *env, jobject thisObject) {
    BRPeerManager *peerManager = (BRPeerManager *) getJNIReference(env, thisObject);
 ...
 */
JNIEXPORT jboolean JNICALL Java_com_swyftwallet_core_BRCorePeerManager_jniUseFixedPeer
        (JNIEnv *env, jobject thisObject,
         jstring nodeString,
         jint port) {
    BRPeerManager *peerManager = (BRPeerManager *) getJNIReference(env, thisObject);
...
Java_com_swyftwallet_core_BRCorePeerManager_getCurrentPeerName
        (JNIEnv *env, jobject thisObject) {
    BRPeerManager *peerManager = (BRPeerManager *) getJNIReference(env, thisObject);
 ...
 */
JNIEXPORT void JNICALL
Java_com_swyftwallet_core_BRCorePeerManager_disconnect
        (JNIEnv *env, jobject thisObject) {
    BRPeerManager *peerManager = (BRPeerManager *) getJNIReference(env, thisObject);
 ...
 */
JNIEXPORT void JNICALL
Java_com_swyftwallet_core_BRCorePeerManager_rescan
        (JNIEnv *env, jobject thisObject) {
    BRPeerManager *peerManager = (BRPeerManager *) getJNIReference(env, thisObject);
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_com_swyftwallet_core_BRCorePeerManager_rescanFromBlock
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_swyftwallet_core_BRCorePeerManager_rescanFromCheckPoint
        (JNIEnv *env, jobject thisObject) {
    BRPeerManager *peerManager = (BRPeerManager *) getJNIReference(env, thisObject);
...
Java_com_swyftwallet_core_BRCorePeerManager_getEstimatedBlockHeight
        (JNIEnv *env, jobject thisObject) {
    BRPeerManager *peerManager = (BRPeerManager *) getJNIReference(env, thisObject);
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_swyftwallet_core_BRCorePeerManager_getLastBlockHeight
        (JNIEnv *env, jobject thisObject) {
    BRPeerManager *peerManager = (BRPeerManager *) getJNIReference(env, thisObject);
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_swyftwallet_core_BRCorePeerManager_getLastBlockTimestamp
        (JNIEnv *env, jobject thisObject) {
    BRPeerManager *peerManager = (BRPeerManager *) getJNIReference(env, thisObject);
 ...
 */
JNIEXPORT jdouble
JNICALL Java_com_swyftwallet_core_BRCorePeerManager_getSyncProgress
...
JNIEXPORT jint JNICALL
        Java_com_swyftwallet_core_BRCorePeerManager_getPeerCount
        (JNIEnv *env, jobject thisObject) {
    BRPeerManager *peerManager = (BRPeerManager *) getJNIReference(env, thisObject);
 ...
 */
JNIEXPORT jstring JNICALL
Java_com_swyftwallet_core_BRCorePeerManager_getDownloadPeerName
        (JNIEnv *env, jobject thisObject) {
    BRPeerManager *peerManager = (BRPeerManager *) getJNIReference(env, thisObject);
 ...
 * Signature: (Lcom_swyftwallet_/core/BRCoreTransaction;)V
 */
JNIEXPORT void JNICALL
Java_com_swyftwallet_core_BRCorePeerManager_publishTransactionWithListener
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_swyftwallet_core_BRCorePeerManager_getRelayCount
 ...
 */
JNIEXPORT void JNICALL 
Java_com_swyftwallet_core_BRCorePeerManager_testSavePeersCallback
 ...
 * Signature: (Lcom_swyftwallet_/core/BRCoreChainParams;Lcom_swyftwallet_/core/BRCoreWallet;D[Lcom_swyftwallet_/core/BRCoreMerkleBlock;[Lcom_swyftwallet_/core/BRCorePeer;Lcom_swyftwallet_/core/BRCorePeerManager/Listener;)J
 */
JNIEXPORT jlong JNICALL
Java_com_swyftwallet_core_BRCorePeerManager_createCorePeerManager
 ...
 */
JNIEXPORT void
JNICALL Java_com_swyftwallet_core_BRCorePeerManager_installListener
 ...
 */
JNIEXPORT void JNICALL
Java_com_swyftwallet_core_BRCorePeerManager_disposeNative
        (JNIEnv *env, jobject thisObject) {
    BRPeerManager *peerManager = (BRPeerManager *) getJNIReference(env, thisObject);
...
saveBlocks(void *info, int replace, BRMerkleBlock *blocks[], size_t blockCount) {
    ...
    jmethodID listenerMethod =
            lookupListenerMethod(env, listener,
                                 "saveBlocks",
                                 "(Z[Lcom_swyftwallet_/core/BRCoreMerkleBlock;)V");
...
savePeers(void *info, int replace, const BRPeer peers[], size_t count) {
    ...
    jmethodID listenerMethod =
            lookupListenerMethod(env, listener,
                                 "savePeers",
                                 "(Z[Lcom_swyftwallet_/core/BRCorePeer;)V");
    assert (NULL != listenerMethod);
