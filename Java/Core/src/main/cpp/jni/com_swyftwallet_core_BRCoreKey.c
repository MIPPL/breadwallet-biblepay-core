...
#include "com_swyftwallet_core_BRCoreKey.h"

/*
 * Class:     com_swyftwallet_core_BRCoreKey
 * Method:    getSecret
 * Signature: ()[B
 */
JNIEXPORT jbyteArray JNICALL
Java_com_swyftwallet_core_BRCoreKey_getSecret
 ...
 */
JNIEXPORT jbyteArray JNICALL
Java_com_swyftwallet_core_BRCoreKey_getPubKey
        (JNIEnv *env, jobject thisObject) {
    BRKey *key = (BRKey *) getJNIReference(env, thisObject);
...
Java_com_swyftwallet_core_BRCoreKey_getCompressed
        (JNIEnv *env, jobject thisObject) {
    BRKey *key = (BRKey *) getJNIReference(env, thisObject);
 ...
 */
JNIEXPORT jstring JNICALL Java_com_swyftwallet_core_BRCoreKey_getPrivKey
        (JNIEnv *env, jobject thisObject) {
    BRKey *key = (BRKey *) getJNIReference(env, thisObject);
...
Java_com_swyftwallet_core_BRCoreKey_getBase58EncodedPublicKey
        (JNIEnv *env, jobject thisObject) {
    BRKey *key = (BRKey *) getJNIReference(env, thisObject);
 ...
 */
JNIEXPORT jbyteArray JNICALL
Java_com_swyftwallet_core_BRCoreKey_getSeedFromPhrase
 ...
 * Signature: ([B)[B
 */
JNIEXPORT jbyteArray JNICALL Java_com_swyftwallet_core_BRCoreKey_getAuthPrivKeyForAPI
 ...
 */
JNIEXPORT jstring JNICALL Java_com_swyftwallet_core_BRCoreKey_getAuthPublicKeyForAPI
 ...
 */
JNIEXPORT jstring JNICALL Java_com_swyftwallet_core_BRCoreKey_decryptBip38Key
...
Java_com_swyftwallet_core_BRCoreKey_createJniCoreKey
 ...
 * Signature: ([BJJ)J
 */
JNIEXPORT jlong JNICALL Java_com_swyftwallet_core_BRCoreKey_createCoreKeyForBIP32
        (JNIEnv *env, jclass thisClass,
 ...
 */
JNIEXPORT jboolean JNICALL Java_com_swyftwallet_core_BRCoreKey_setPrivKey
...
Java_com_swyftwallet_core_BRCoreKey_setSecret
 ...
 */
JNIEXPORT jbyteArray JNICALL
Java_com_swyftwallet_core_BRCoreKey_compactSign
 ...
 * Signature: ([B[B)J
 */
JNIEXPORT jlong JNICALL Java_com_swyftwallet_core_BRCoreKey_createKeyRecoverCompactSign
        (JNIEnv *env, jclass thisClass,
 ...
 */
JNIEXPORT jbyteArray JNICALL
Java_com_swyftwallet_core_BRCoreKey_encryptNative
        (JNIEnv *env, jobject thisObject,
         jbyteArray dataByteArray,
 ...
 */
JNIEXPORT jbyteArray JNICALL
Java_com_swyftwallet_core_BRCoreKey_decryptNative
        (JNIEnv *env, jobject thisObject,
         jbyteArray dataByteArray,
         jbyteArray nonceByteArray) {
    BRKey *key = (BRKey *) getJNIReference(env, thisObject);
 ...
 * Signature: ([B[B[B)[B
 */
JNIEXPORT jbyteArray JNICALL Java_com_swyftwallet_core_BRCoreKey_encryptUsingSharedSecret
        (JNIEnv *env, jobject thisObject,
 ...
 * Signature: ([B[B[B)[B
 */
JNIEXPORT jbyteArray JNICALL Java_com_swyftwallet_core_BRCoreKey_decryptUsingSharedSecret
        (JNIEnv *env, jobject thisObject,
         jbyteArray publicKeyByteArray,
         jbyteArray dataByteArray,
         jbyteArray nonceByteArray) {
 ...
 * Signature: ([B)J
 */
JNIEXPORT jlong JNICALL Java_com_swyftwallet_core_BRCoreKey_createPairingKey
        (JNIEnv *env, jobject thisObject,
 ...
 */
JNIEXPORT jstring JNICALL
Java_com_swyftwallet_core_BRCoreKey_address
        (JNIEnv *env, jobject thisObject) {
    BRKey *key = (BRKey *) getJNIReference(env, thisObject);
 ...
 */
JNIEXPORT jstring JNICALL
Java_com_swyftwallet_core_BRCoreKey_addressLegacy
        (JNIEnv *env, jobject thisObject) {
    BRKey *key = (BRKey *) getJNIReference(env, thisObject);
 ...
 */
JNIEXPORT jboolean JNICALL
Java_com_swyftwallet_core_BRCoreKey_isValidBitcoinPrivateKey
 ...
 * Signature: (Ljava/lang/String;)Z
 */
JNIEXPORT jboolean JNICALL Java_com_swyftwallet_core_BRCoreKey_isValidBitcoinBIP38Key
        (JNIEnv *env, jclass thisClass, jstring stringObject) {
    const char *privKey = (*env)->GetStringUTFChars(env, stringObject, 0);
 ...
 * Signature: ([B)[B
 */
JNIEXPORT jbyteArray JNICALL Java_com_swyftwallet_core_BRCoreKey_encodeSHA256
        (JNIEnv *env, jclass thisClass,
 ...
 * Signature: ([B)[B
 */
JNIEXPORT jbyteArray JNICALL Java_com_swyftwallet_core_BRCoreKey_encodeSHA256Double
        (JNIEnv *env, jclass thisClass,
         jbyteArray messageByteArray) {
    uint8_t md[32];
 ...
 * Signature: ([B)Ljava/lang/String;
 */
JNIEXPORT jstring JNICALL Java_com_swyftwallet_core_BRCoreKey_encodeBase58
        (JNIEnv *env, jclass thisClass,
         jbyteArray messageByteArray) {
 ...
 */
JNIEXPORT jbyteArray JNICALL Java_com_swyftwallet_core_BRCoreKey_decodeBase58
        (JNIEnv *env, jclass thisClass,
 ...
 */
JNIEXPORT jbyteArray JNICALL
Java_com_swyftwallet_core_BRCoreKey_sign
        (JNIEnv *env, jobject thisObject,
 ...
 */
JNIEXPORT jboolean JNICALL
Java_com_swyftwallet_core_BRCoreKey_verify
        (JNIEnv *env, jobject thisObject,
         jbyteArray messageDigestByteArray,
