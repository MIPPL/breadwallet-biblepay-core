...
Java_com_swyftwallet_core_BRCoreTransaction_getHash
 ...
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_com_swyftwallet_core_BRCoreTransaction_getVersion
        (JNIEnv *env, jobject thisObject) {
    BRTransaction *transaction = (BRTransaction *) getJNIReference (env, thisObject);
 ...
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_com_swyftwallet_core_BRCoreTransaction_getLockTime
        (JNIEnv *env, jobject thisObject) {
    BRTransaction *transaction = (BRTransaction *) getJNIReference (env, thisObject);
...
Java_com_swyftwallet_core_BRCoreTransaction_setLockTime
 ...
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_com_swyftwallet_core_BRCoreTransaction_getBlockHeight
        (JNIEnv *env, jobject thisObject) {
    BRTransaction *transaction = (BRTransaction *) getJNIReference (env, thisObject);
...
Java_com_swyftwallet_core_BRCoreTransaction_getTimestamp
        (JNIEnv *env, jobject thisObject) {
    BRTransaction *transaction = (BRTransaction *) getJNIReference (env, thisObject);
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_com_swyftwallet_core_BRCoreTransaction_setTimestamp
 ...
 * Signature: ()[B
 */
JNIEXPORT jbyteArray JNICALL Java_com_swyftwallet_core_BRCoreTransaction_serialize
        (JNIEnv *env, jobject thisObject) {
    BRTransaction *transaction = (BRTransaction *) getJNIReference (env, thisObject);
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_swyftwallet_core_BRCoreTransaction_shuffleOutputs
        (JNIEnv *env, jobject thisObject) {
    BRTransaction *transaction = (BRTransaction *) getJNIReference (env, thisObject);
 ...
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_com_swyftwallet_core_BRCoreTransaction_getSize
        (JNIEnv *env, jobject thisObject) {
    BRTransaction *transaction = (BRTransaction *) getJNIReference (env, thisObject);
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_swyftwallet_core_BRCoreTransaction_getStandardFee
        (JNIEnv *env, jobject thisObject) {
    BRTransaction *transaction = (BRTransaction *) getJNIReference (env, thisObject);
...
Java_com_swyftwallet_core_BRCoreTransaction_isSigned
        (JNIEnv *env, jobject thisObject) {
    BRTransaction *transaction = (BRTransaction *) getJNIReference (env, thisObject);
 ...
 * Signature: ()Z
 */
JNIEXPORT jboolean JNICALL Java_com_swyftwallet_core_BRCoreTransaction_isStandard
        (JNIEnv *env, jobject thisObject) {
    BRTransaction *transaction = (BRTransaction *) getJNIReference (env, thisObject);
 ...
 */
JNIEXPORT jstring JNICALL Java_com_swyftwallet_core_BRCoreTransaction_getReverseHash
        (JNIEnv *env, jobject thisObject) {
    BRTransaction *transaction = (BRTransaction *) getJNIReference (env, thisObject);
 ...
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_com_swyftwallet_core_BRCoreTransaction_getMinOutputAmount
 ...
 */
JNIEXPORT void JNICALL
Java_com_swyftwallet_core_BRCoreTransaction_disposeNative
        (JNIEnv *env, jobject thisObject) {
    BRTransaction *transaction = (BRTransaction *) getJNIReference (env, thisObject);
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_swyftwallet_core_BRCoreTransaction_createJniCoreTransaction
        (JNIEnv *env, jclass thisClass,
 ...
 * Signature: ([B)J
 */
JNIEXPORT jlong JNICALL Java_com_swyftwallet_core_BRCoreTransaction_createJniCoreTransactionSerialized
 ...
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_com_swyftwallet_core_BRCoreTransaction_createJniCoreTransactionEmpty
        (JNIEnv *env, jclass thisClass) {
