...
#include "com_swyftwallet_core_BRCoreTransactionOutput.h"

/*
 * Class:     com_swyftwallet_core_BRCoreTransactionOutput
 * Method:    createTransactionOutput
 * Signature: (J[B)J
 */
JNIEXPORT jlong JNICALL
Java_com_swyftwallet_core_BRCoreTransactionOutput_createTransactionOutput
...
Java_com_swyftwallet_core_BRCoreTransactionOutput_getAddress
...
Java_com_swyftwallet_core_BRCoreTransactionOutput_setAddress
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_swyftwallet_core_BRCoreTransactionOutput_getAmount
        (JNIEnv *env, jobject thisObject) {
    BRTxOutput *output = (BRTxOutput *) getJNIReference (env, thisObject);
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_com_swyftwallet_core_BRCoreTransactionOutput_setAmount
 ...
 * Signature: ()[B
 */
JNIEXPORT jbyteArray JNICALL Java_com_swyftwallet_core_BRCoreTransactionOutput_getScript
        (JNIEnv *env, jobject thisObject) {
    BRTxOutput *output = (BRTxOutput *) getJNIReference (env, thisObject);
