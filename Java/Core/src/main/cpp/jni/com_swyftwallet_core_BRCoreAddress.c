...
#include "com_swyftwallet_core_BRCoreAddress.h"

/*
 * Class:     com_swyftwallet_core_BRCoreAddress
 * Method:    createCoreAddress
 * Signature: (Ljava/lang/String;)J
 */
JNIEXPORT jlong JNICALL
Java_com_swyftwallet_core_BRCoreAddress_createCoreAddress
 ...
 * Signature: ([B)J
 */
JNIEXPORT jlong JNICALL Java_com_swyftwallet_core_BRCoreAddress_createCoreAddressFromScriptPubKey
 ...
 * Signature: ([B)J
 */
JNIEXPORT jlong JNICALL Java_com_swyftwallet_core_BRCoreAddress_createCoreAddressFromScriptSignature
        (JNIEnv *env, jclass thisClass, jbyteArray scriptByteArray) {
    BRAddress *address = (BRAddress *) calloc(1, sizeof(BRAddress));
...
Java_com_swyftwallet_core_BRCoreAddress_stringify
...
Java_com_swyftwallet_core_BRCoreAddress_isValid
        (JNIEnv *env, jobject thisObject) {
    BRAddress *address = (BRAddress *) getJNIReference(env, thisObject);
...
Java_com_swyftwallet_core_BRCoreAddress_getPubKeyScript
        (JNIEnv *env, jobject thisObject) {
    BRAddress *address = (BRAddress *) getJNIReference(env, thisObject);
 ...
 */
JNIEXPORT jstring JNICALL Java_com_swyftwallet_core_BRCoreAddress_bcashDecodeBitcoin
 ...
 * Signature: (Ljava/lang/String;)Ljava/lang/String;
 */
JNIEXPORT jstring JNICALL Java_com_swyftwallet_core_BRCoreAddress_bcashEncodeBitcoin
